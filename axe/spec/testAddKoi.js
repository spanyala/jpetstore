		...
		driver.findElement(selenium.By.id("Catalog"))
            .then(function () {
			    ...
			    var stream = fs.createWriteStream("reports/testAddKoi.html");
					...
					stream.write("<span color='#0000FF'>Violation #" + violation_num + "/" + results.violations.length + "</span>\n");
					...
					stream.write("<br/>\n");
						...
						var error_num = j+1;
						stream.write("<div><span style='color:#ff0000'>&nbsp;&nbsp;&nbsp;&nbsp;Error #" + error_num + "/" + results.violations[i].nodes.length + "</div>\n");
